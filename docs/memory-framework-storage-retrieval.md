...
> 调研日期：2026-08-26  
> 范围：只讨论“记忆已经产生之后，如何存储与召回”，不讨论抽取 Prompt、抽取模型和模型能力。  
> 对象：Mem0、Zep / Graphiti、Letta、LangMem / LangGraph、Supermemory、Cognee。  
> 口径：“主流”表示有代表性的公开框架与产品路线，不代表市场份额排名。开源实现优先依据固定源码；托管服务未公开的部分只按官方契约描述。
